...
function loadDataTable(table, STT) {
    table = $('#datatable-report').DataTable({
        ...
        "ajax": {
            "url": "/ReportPayrollSummary/GetEntityForDatatable",
            "type": "POST",
            "datatype": "json",
            "data": {
                'dateFrom': $("#dateFrom").val(),
        ...
        "columns": [
            ...
            { "data": "Position", "name": "Position", "width": "60%" },
            { "data": "Amount", "name": "Amount", "width": "30%", "render": $.fn.dataTable.render.number(',', '', 0, ''), "class": "dt-body-right" },
        ],
